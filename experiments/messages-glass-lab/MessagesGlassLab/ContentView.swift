...
private let threads: [LabThread] = [
    ...
    .init(title: "Fix dark-mode header glass", subtitle: "coda/ipad-responsive-mobile-layout", time: "2h", initials: "DG", tint: .indigo, preview: "Compare dark scroll-edge material against Messages and Mail, then map the behavior back to React Native Screens."),
