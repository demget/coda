 ...
 * immediately or on inactivity past the window. Open PRs block inactivity,
 * and closed-but-unmerged PRs stay active because closing does not mean the
 * work landed. The server
