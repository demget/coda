 ...
 * every shell Coda spawns (zsh, bash, fish, PowerShell): it installs
...
const projectRoot = process.env.CODA_PROJECT_ROOT;
if (!projectRoot) {
  throw new Error("CODA_PROJECT_ROOT is not set. Run this through the t3.json setup action.");
}
