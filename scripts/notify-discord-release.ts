  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Coda prerelease is available for nightly testers."
          : "A new Coda latest release is available.",
...
).pipe(Command.withDescription("Post a Coda release announcement to Discord."));
