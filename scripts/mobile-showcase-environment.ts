...
const PROJECT_FAVICONS = {
  coda: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
  <rect width="128" height="128" fill="#11120F"/>
  <path id="coda-turn" d="M29 84C27.1 85 25.5 83.6 25.5 81.5V38.5C25.5 35.4 27.2 32.6 30 31.2L69.3 10.8C71 9.9 73 11.1 73 13V35.7C73 37.8 71.7 39.1 69.5 39.1H65.3C54.8 39.1 46 46.6 43.8 56.8C42.5 62.9 44.2 68.6 48.1 72.8C50.1 74.9 49.4 77.4 46.8 78.8L29 84Z" fill="#FAFBF4"/>
  <use href="#coda-turn" transform="rotate(180 64 64)"/>
</svg>`,
...
async function seedCodaWorkspace(workspaceRoot: string): Promise<void> {
...
export async function seedShowcaseEnvironment(input: {
  ...
  if (primaryProject.id === SHOWCASE_PROJECT_ID) {
    await seedCodaWorkspace(workspaceRoot);
  }
  await Promise.all(
    projects
