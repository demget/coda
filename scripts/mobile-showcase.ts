...
const ANDROID_PACKAGE = "com.coda.app";
const APP_SCHEME = "coda";
...
const IOS_APP_PATH = NodePath.join(
  MOBILE_ROOT,
  ".showcase/ios-derived-data/Build/Products/Debug-iphonesimulator/Coda.app",
);
...
async function buildIos(): Promise<string> {
  ...
  await runCommand(
    ...
    [
      "-workspace",
      NodePath.join(MOBILE_ROOT, "ios/Coda.xcworkspace"),
      "-scheme",
      "Coda",
      "-configuration",
      "Debug",
