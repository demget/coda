...
Antigravity uses its own permission policy for each mode. Coda still shows any approval or
...
Coda's separate Plan mode control is not available for Antigravity. See
