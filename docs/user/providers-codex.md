...
Both instances must use the same **CODEX_HOME path**. Coda prepares the shared
...
Choose the other account from the thread's model picker. Coda offers compatible
