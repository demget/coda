...
Terms whose meaning matters across Coda. Architecture and lifecycle constraints belong in the
...
| Term                | Meaning                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------ |
| Provider            | The agent runtime Coda controls, such as Codex or Claude Code.                                               |
...
| Adapter             | The boundary translating a provider's native protocol into Coda operations and events.                       |
