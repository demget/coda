...
export const PERSISTED_STATE_KEY = "coda:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "coda:renderer-state:v8",
  "coda:renderer-state:v7",
  "coda:renderer-state:v6",
  "coda:renderer-state:v5",
  "coda:renderer-state:v4",
  "coda:renderer-state:v3",
