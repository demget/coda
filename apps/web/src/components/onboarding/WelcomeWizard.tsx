    ...
    <Dialog open disablePointerDismissal onOpenChange={(_, event) => event.cancel()}>
      ...
      >
        <WizardHeader
          title="Set up Coda"
          identity={
            <div className="flex items-baseline gap-1.5" role="img" aria-label="Coda">
              <CodaMark className="h-4 w-auto shrink-0" aria-hidden />
        ...
        <CollapsiblePanel keepMounted>
          <div className="px-3 pb-3">
            ...
            <p className="mt-3 text-xs text-muted-foreground">
              Keep Coda running. Select the computers you want to set up above.
            </p>
          </div>
        </CollapsiblePanel>
      </Collapsible>
        ...
        <Collapsible>
          ...
          <CollapsiblePanel>
            ...
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start Coda first, or run <code className="font-mono">npx t3 serve</code>. Add{" "}
