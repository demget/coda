...
describe("ComposerPendingApprovalPanel", () => {
  it("presents the request as a single approval console", () => {
    ...
    expect(markup).toContain('aria-label="Approval required"');
    expect(markup).toContain("The agent wants to run this command.");
