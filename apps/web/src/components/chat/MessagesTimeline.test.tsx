...
describe("MessagesTimeline", () => {
  ...
  it("formats changed file paths from the workspace root", () => {
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/coda/apps/web/src/session-logic.ts"],
            },
          },
        ]}
    ...
    expect(markup).toContain("coda/apps/web/src/session-logic.ts");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/coda/apps/web/src/session-logic.ts");
  });
