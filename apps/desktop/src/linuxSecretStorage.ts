...
function getGnomeKeyringRemediationMessage(): string {
  return "Coda could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Coda.";
}

function getKWalletRemediationMessage(): string {
  return "Coda could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Coda.";
}
