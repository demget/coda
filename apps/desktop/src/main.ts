...
// SSH installs the official runtime matching the bundled server version.
// Coda desktop versions include a fork suffix that official archives do not carry.
// Development can point the remote at a source checkout.
