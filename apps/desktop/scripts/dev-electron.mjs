...
if (devProtocolClient) {
  childEnv.CODA_DESKTOP_APP_USER_MODEL_ID = devProtocolClient.appBundleId;
  childEnv.CODA_DESKTOP_PROTOCOL_REGISTRATION_MANAGED = "1";
}
...
function cleanupStaleDevApps() {
  ...
  NodeChildProcess.spawnSync("pkill", ["-f", "--", `--coda-dev-root=${desktopDir}`], {
    stdio: "ignore",
  });
}
...
function startApp() {
  ...
  const launchArgs = devProtocolClient
    ? electronArgs
    : [...electronArgs, `--coda-dev-root=${desktopDir}`, "dist-electron/main.cjs"];
