...
const isIosPersonalTeamBuild = repoEnv.CODA_IOS_PERSONAL_TEAM === "1";
const runtimeVersionPolicy =
  process.env.MOBILE_VERSION_POLICY ??
  (APP_VARIANT === "development" ? "appVersion" : "fingerprint");

const personalTeamBundleIdentifier = repoEnv.CODA_IOS_PERSONAL_TEAM_BUNDLE_ID?.trim();
...
if (
  ...
  throw new Error(
    "CODA_IOS_PERSONAL_TEAM_BUNDLE_ID must be a reverse-DNS identifier such as com.example.t3code when CODA_IOS_PERSONAL_TEAM=1.",
  );
}
...
const DEVELOPMENT_ASSETS = {
  ...
  androidAdaptiveForeground: "./assets/android-icon-mark-dark.png",
  androidAdaptiveBackgroundColor: "#FAFBF4",
  androidMonochromeIcon: "./assets/android-icon-mark-dark.png",
  androidAdaptiveBackgroundImage: undefined,
  androidSplashIcon: "./assets/android-icon-mark-dark.png",
  androidNotificationIcon: "./assets/android-notification-icon.png",
  androidNotificationColor: "#11120F",
} as const;
...
const PREVIEW_ASSETS = {
  ...
  androidAdaptiveBackgroundColor: "#30312D",
  androidMonochromeIcon: "./assets/android-icon-mark-dark.png",
  androidAdaptiveBackgroundImage: undefined,
  androidSplashIcon: "./assets/android-icon-mark.png",
  androidNotificationIcon: "./assets/android-notification-icon.png",
  androidNotificationColor: "#11120F",
} as const;
...
const RELEASE_ASSETS = {
  ...
  androidAdaptiveForeground: "./assets/android-icon-mark.png",
  androidAdaptiveBackgroundColor: "#11120F",
  androidAdaptiveBackgroundImage: undefined,
  androidSplashIcon: "./assets/android-icon-mark.png",
...
const VARIANT_CONFIG = {
  development: {
    appName: "Coda Dev",
    scheme: "coda-dev",
    iosBundleIdentifier: "com.coda.app.dev",
    androidPackage: "com.coda.app.dev",
  ...
  preview: {
    ...
    scheme: "coda-preview",
    iosBundleIdentifier: "com.coda.app.preview",
    androidPackage: "com.coda.app.preview",
    relyingParty: "clerk.t3.codes",
  ...
  production: {
    appName: "Coda",
    scheme: "coda",
    iosBundleIdentifier: "com.coda.app",
    androidPackage: "com.coda.app",
    relyingParty: "clerk.t3.codes",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSPhotoLibraryAddUsageDescription: "Allow Coda to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow Coda to use your microphone for voice input.",
  ...
  extra: {
    ...
    relay: {
      url: repoEnv.CODA_RELAY_URL ?? null,
    },
    clerk: {
