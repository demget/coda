  ...
  if (props.provider === "kimi") {
    return (
      <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Rect x="3" y="4.5" width="18" height="13" rx="2.2" stroke={mono} strokeWidth="1.6" />
        <Rect x="9.6" y="8" width="1.4" height="2.6" rx="0.45" fill={mono} />
        <Rect x="15.6" y="8" width="1.4" height="2.6" rx="0.45" fill={mono} />
      </Svg>
    );
  }
