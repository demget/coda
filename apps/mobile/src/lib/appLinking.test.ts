...
describe("shouldHandleAppLink", () => {
  it.each(["coda://", "coda:///", "coda-dev://", "coda-preview://"])(
  ...
  it.each([
    "coda://threads/env-1/thread-1",
    "coda://pair?pairingUrl=x",
    "coda-dev://settings/usage?tab=limits",
  ])("handles path-bearing URL %s", (url) => {
    expect(shouldHandleAppLink(url)).toBe(true);
  });

  it.each(["coda://expo-development-client/?url=x", "coda://expo-sharing/anything"])(
