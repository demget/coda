    ...
    Effect.gen(function* () {
      ...
      const configLayer = ConfigProvider.layer(
        ConfigProvider.fromUnknown({
          CODA_TELEMETRY_ENABLED: true,
          CODA_POSTHOG_KEY: "phc_test_key",
          CODA_POSTHOG_HOST: "http://localhost",
          CODA_TELEMETRY_FLUSH_BATCH_SIZE: 20,
        }),
      );
