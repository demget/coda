...
it("detects package runners from their cache entry paths", () => {
  ...
  assert.equal(
    detectCliRunner("/home/theo/.cache/pnpm/dlx/abc/node_modules/coda/dist/bin.mjs"),
    "pnpm dlx",
  );
  assert.equal(
    detectCliRunner("/home/theo/.local/share/pnpm/.pnpm/dlx/abc/node_modules/coda/dist/bin.mjs"),
    "pnpm dlx",
  );
  assert.equal(
    detectCliRunner(
...
it("treats stable installs as direct invocations", () => {
  assert.isNull(detectCliRunner("/usr/local/lib/node_modules/coda/dist/bin.mjs"));
  assert.isNull(detectCliRunner("/home/theo/Code/work/coda/apps/server/dist/bin.mjs"));
  assert.isNull(detectCliRunner("/home/theo/.coda/runtime/0.0.31/node_modules/coda/dist/bin.mjs"));
...
it("formats serve suggestions to match the launching command", () => {
  assert.equal(
    formatCliCommand({
      subcommand: "serve",
      entryPath: "/home/theo/.npm/_npx/abc/node_modules/coda/dist/bin.mjs",
      version: "0.0.31-nightly.20260729",
    }),
    "npx coda@nightly serve",
  );
  assert.equal(
    formatCliCommand({
      subcommand: "serve",
