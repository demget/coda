import {
  ...
  ThreadTurnCompletionAssessedPayload as ContractsThreadTurnCompletionAssessedPayloadSchema,
...
export const ThreadTurnCompletionAssessedPayload =
  ContractsThreadTurnCompletionAssessedPayloadSchema;
