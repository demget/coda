  ...
  Effect.mapError(
    () =>
      new EnvironmentHttpInternalServerError({
        message: "CODA_RELAY_URL must be configured as a secure absolute HTTPS origin.",
      }),
  ),
);
...
// explicit launcher stop (`coda service uninstall`, `systemctl stop`,
...
export const releaseManagedTunnelOnShutdown = Effect.fn(
  ...
  // persisted URL: CODA_RELAY_URL may have changed since the link was made.
