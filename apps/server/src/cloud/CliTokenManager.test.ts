...
const TEST_ENV = {
  CODA_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  CODA_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  CODA_HOSTED_APP_URL: "https://hosted.example.test",
};
