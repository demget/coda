...
const T3_CODE_BROWSER_TOOL_INSTRUCTIONS = `## Coda collaborative browser
...
const T3_CODE_DEVICE_TOOL_INSTRUCTIONS = `## Coda devices
...
/**
 * Coda context for `turn/start.additionalContext`. Codex renders each entry
